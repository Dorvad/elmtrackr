...
echo Running: gradlew assembleRelease (skip lint vital - locked by AS) >> %LOG%
call gradlew.bat assembleRelease -x lintVitalAnalyzeRelease -x lintVitalReportRelease -x lintVitalRelease >> %LOG% 2>&1
