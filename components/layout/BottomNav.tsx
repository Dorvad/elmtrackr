  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 safe-area-pb">
      <div
        ...
        style={{
          background: "rgba(236,238,250,0.85)",
...
function HomeIcon({ active }: { active: boolean }) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={active ? "#fff" : "var(--au-faint)"} strokeWidth={active ? 2.2 : 2} strokeLinecap="round" strokeLinejoin="round">
